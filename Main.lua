...
local funcs = {}; do
    function funcs:require(url, bypass, bypass2)
        ...
        local newUrl = (bypass and "https://raw.githubusercontent.com/7GRANDCRACKED/" or "https://raw.githubusercontent.com/7GRANDCRACKED/engoware/main/") .. url:gsub("engoware/", ""):gsub("engoware\\", "")
    ...
    if State == Enum.TeleportState.Started then
		local stringtp = [[
            if engoware_developer then 
                ...
                loadstring(game:HttpGet("https://raw.githubusercontent.com/7GRANDCRACKED/engoware/main/Main.lua", true))() 
            end
        ]]
